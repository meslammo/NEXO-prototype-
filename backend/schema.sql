...
('crafted-shadow-mask','Shadow Mask','Epic',0,TRUE,'assets/nexo/crafted/shadow-mask.svg','مصنوع بالـWorkshop',TRUE,'crafted','crafted','قطعة تصنيع.','pulse',FALSE,0,'[]'::jsonb,'{}'::jsonb),
('crafted-phoenix-seal','Phoenix Seal','Legendary',0,TRUE,'assets/nexo/crafted/phoenix-seal.svg','ختم الفينيكس',TRUE,'crafted','crafted','قطعة تصنيع نادرة.','shine',FALSE,0,'[]'::jsonb,'{}'::jsonb),
('crafted-prism-token','Prism Token','Rare',0,TRUE,'assets/nexo/crafted/prism-token.svg','توكن طيفي',TRUE,'crafted','crafted','قطعة مصنعة.','rainbow',FALSE,0,'[]'::jsonb,'{}'::jsonb),
('crafted-nebula-core','Nebula Core','Epic',0,TRUE,'assets/nexo/crafted/nebula-core.svg','نواة سديم',TRUE,'crafted','crafted','نواة مصنعة.','orbit',FALSE,0,'[]'::jsonb,'{}'::jsonb),
('crafted-golden-signet','Golden Signet','Legendary',0,TRUE,'assets/nexo/crafted/golden-signet.svg','خاتم ذهبي مصنوع',TRUE,'crafted','crafted','ختم ملكي مصنوع.','shine',FALSE,0,'[]'::jsonb,'{}'::jsonb),
('crafted-arcana','NEXO Arcana','NEXO Exclusive',0,FALSE,'assets/nexo/crafted/nexo-arcana.svg','أركانا NEXO',TRUE,'crafted','crafted','قطعة تصنيع حصرية.','orbit',FALSE,0,'[]'::jsonb,'{}'::jsonb),
