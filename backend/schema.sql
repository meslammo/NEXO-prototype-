...
('frame-01-sunrise','Sunrise Frame','Common',100,TRUE,'frame-01-sunrise.png','Sunrise Frame',TRUE,'frame','frames','Sunrise Frame','shine',TRUE,100,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-02-simple-gold','Simple Gold','Common',150,TRUE,'frame-02-simple-gold.png','Simple Gold',TRUE,'frame','frames','Simple Gold','shine',TRUE,101,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-03-ocean-wave','Ocean Wave','Common',200,TRUE,'frame-03-ocean-wave.png','Ocean Wave',TRUE,'frame','frames','Ocean Wave','float',TRUE,102,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-04-papyrus-ring','Papyrus Ring','Common',250,TRUE,'frame-04-papyrus-ring.png','Papyrus Ring',TRUE,'frame','frames','Papyrus Ring','pulse',TRUE,103,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
...
('frame-05-desert-oasis','Desert Oasis','Uncommon',400,TRUE,'frame-05-desert-oasis.png','Desert Oasis',TRUE,'frame','frames','Desert Oasis','float',TRUE,105,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-06-balloon-party','Balloon Party','Uncommon',500,TRUE,'frame-06-balloon-party.png','Balloon Party',TRUE,'frame','frames','Balloon Party','pulse',TRUE,106,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-07-zodiac','Zodiac Frame','Uncommon',650,TRUE,'frame-07-zodiac.png','Zodiac Frame',TRUE,'frame','frames','Zodiac Frame','orbit',TRUE,107,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-08-bronze-lv10','Bronze Frame (Lv.10)','Uncommon',800,TRUE,'frame-08-bronze-lv10.png','Bronze Frame (Lv.10)',TRUE,'frame','frames','Bronze Frame (Lv.10)','shine',TRUE,108,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-09-bonded-hearts','Bonded Hearts Frame','Uncommon',1000,TRUE,'frame-09-bonded-hearts.png','Bonded Hearts Frame',TRUE,'frame','frames','Bonded Hearts Frame','pulse',TRUE,109,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
...
('frame-10-crystal-ring','Crystal Ring','Rare',1500,TRUE,'frame-10-crystal-ring.png','Crystal Ring',TRUE,'frame','frames','Crystal Ring','shine',TRUE,111,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-11-warrior','Warrior Frame','Rare',2000,TRUE,'frame-11-warrior.png','Warrior Frame',TRUE,'frame','frames','Warrior Frame','float',TRUE,112,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-12-love-bloom','Love Bloom','Rare',2500,TRUE,'frame-12-love-bloom.png','Love Bloom',TRUE,'frame','frames','Love Bloom','pulse',TRUE,113,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-13-silver-lv25','Silver Frame (Lv.25)','Rare',3000,TRUE,'frame-13-silver-lv25.png','Silver Frame (Lv.25)',TRUE,'frame','frames','Silver Frame (Lv.25)','shine',TRUE,114,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-14-ramadan-lantern','Ramadan Lantern Frame','Rare',4000,TRUE,'frame-14-ramadan-lantern.png','Ramadan Lantern Frame',TRUE,'frame','frames','Ramadan Lantern Frame','shine',TRUE,115,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
...
('frame-15-fire-lion','Fire Lion','Epic',6000,TRUE,'frame-15-fire-lion.png','Fire Lion',TRUE,'frame','frames','Fire Lion','float',TRUE,117,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-16-diamond-princess','Diamond Princess','Epic',7500,TRUE,'frame-16-diamond-princess.png','Diamond Princess',TRUE,'frame','frames','Diamond Princess','shine',TRUE,118,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-17-golden-wings','Golden Wings','Epic',9000,TRUE,'frame-17-golden-wings.png','Golden Wings',TRUE,'frame','frames','Golden Wings','float',TRUE,119,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-18-gold-lv50','Gold Frame (Lv.50)','Epic',11000,TRUE,'frame-18-gold-lv50.png','Gold Frame (Lv.50)',TRUE,'frame','frames','Gold Frame (Lv.50)','shine',TRUE,120,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-19','Frame 19','Epic',13000,TRUE,'frame-19-frame-19.png','Frame 19',TRUE,'frame','frames','Frame 19','pulse',TRUE,121,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-20-eternal-bond','Eternal Bond Frame','Epic',15000,TRUE,'frame-20-eternal-bond.png','Eternal Bond Frame',TRUE,'frame','frames','Eternal Bond Frame','pulse',TRUE,122,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
...
('frame-21-noble','Noble Frame (Rank 1/6)','Legendary',20000,TRUE,'frame-21-noble.png','Noble Frame (Rank 1/6)',TRUE,'frame','frames','Noble Frame (Rank 1/6)','shine',TRUE,124,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-22-scribe','Scribe Frame (Rank 2/6)','Legendary',25000,TRUE,'frame-22-scribe.png','Scribe Frame (Rank 2/6)',TRUE,'frame','frames','Scribe Frame (Rank 2/6)','shine',TRUE,125,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-23-vizier','Vizier Frame (Rank 3/6)','Legendary',30000,TRUE,'frame-23-vizier.png','Vizier Frame (Rank 3/6)',TRUE,'frame','frames','Vizier Frame (Rank 3/6)','shine',TRUE,126,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-24-platinum-lv100','Platinum Frame (Lv.100)','Legendary',40000,TRUE,'frame-24-platinum-lv100.png','Platinum Frame (Lv.100)',TRUE,'frame','frames','Platinum Frame (Lv.100)','shine',TRUE,127,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-25-anniversary','Anniversary Frame','Legendary',50000,TRUE,'frame-25-anniversary.png','Anniversary Frame',TRUE,'frame','frames','Anniversary Frame','pulse',TRUE,128,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
...
('frame-26-high-priest','High Priest Frame (Rank 4/6)','Mythic',75000,TRUE,'frame-26-high-priest.png','High Priest Frame (Rank 4/6)',TRUE,'frame','frames','High Priest Frame (Rank 4/6)','shine',TRUE,130,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-27-nomarch','Nomarch Frame (Rank 5/6)','Mythic',100000,TRUE,'frame-27-nomarch.png','Nomarch Frame (Rank 5/6)',TRUE,'frame','frames','Nomarch Frame (Rank 5/6)','shine',TRUE,131,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-28-pharaoh','Pharaoh Frame (Rank 6/6)','Mythic',150000,TRUE,'frame-28-pharaoh.png','Pharaoh Frame (Rank 6/6)',TRUE,'frame','frames','Pharaoh Frame (Rank 6/6)','shine',TRUE,132,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-29-mythic-lv200','Mythic Frame (Lv.200)','Mythic',200000,TRUE,'frame-29-mythic-lv200.png','Mythic Frame (Lv.200)',TRUE,'frame','frames','Mythic Frame (Lv.200)','shine',TRUE,133,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
('frame-30-new-year','New Year Frame','Mythic',250000,TRUE,'frame-30-new-year.png','New Year Frame',TRUE,'frame','frames','New Year Frame','orbit',TRUE,134,'[]'::jsonb,'{"source":"legacy_six","group":"frames36"}'::jsonb),
